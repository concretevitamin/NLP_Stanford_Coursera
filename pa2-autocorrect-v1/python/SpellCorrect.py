...
def main():
  ...
  #Jprint 'Uniform Language Model: '
  #JuniformLM = UniformLanguageModel(trainingCorpus)
  #JuniformSpell = SpellCorrect(uniformLM, trainingCorpus)
  #JuniformOutcome = uniformSpell.evaluate(devCorpus) 
  #Jprint str(uniformOutcome)
